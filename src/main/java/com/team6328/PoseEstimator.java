...
public class PoseEstimator {
  ...
  private static class PoseUpdate {
    ...
    public ArrayList<VisionUpdate> visionUpdates;

    public PoseUpdate(Twist2d twist, ArrayList<VisionUpdate> visionUpdates){
      this.twist = twist;
  ...
  public static class VisionUpdate {
    ...
    public VisionUpdate(Pose2d pose, Matrix<N3, N1> stdDevs){
      this.pose = pose;
